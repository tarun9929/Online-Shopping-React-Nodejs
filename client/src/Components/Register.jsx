...
import user from "../Utils/UserRegistration";
import useApiData from "../Hooks/useApiData";

function Register() {
  const { inputData: email, handleInputChange: handleEmailChange } =
    useFormInputData("");
  const { inputData: password, handleInputChange: handlePasswordChange } =
    useFormInputData("");
  const {
    inputData: confirmation,
